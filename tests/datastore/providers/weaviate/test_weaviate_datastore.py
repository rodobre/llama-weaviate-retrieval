...
def test_upsert(weaviate_client, document_id):
    ...
    weaviate_doc = (
        weaviate_client.query.get("CustomDocument", properties)
    ...
    weaviate_docs = weaviate_doc["data"]["Get"]["CustomDocument"]
...
def test_upsert_no_metadata(weaviate_client):
    ...
    weaviate_doc = weaviate_client.query.get("CustomDocument", metadata_properties).do()

    weaviate_doc = weaviate_doc["data"]["Get"]["CustomDocument"][0]
...
def test_upsert_same_docid(test_db, weaviate_client):
    def get_doc_by_document_id(document_id):
        ...
        return results["data"]["Get"]["CustomDocument"]
